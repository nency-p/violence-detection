...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .get-started-btn { background:linear-gradient(135deg,#ff6b6b,#ee5a24,#ff6b6b); color:white; font-size:1.4em; font-weight:700; padding:20px 50px; border:none; border-radius:50px; cursor:pointer; text-transform:uppercase; letter-spacing:2px; position:relative; overflow:hidden; box-shadow:0 10px 30px rgba(255,107,107,0.3); animation:buttonPulse 2s ease-in-out infinite; }
...
<body>
    ...
    <div class="auth-container" id="authContainer">
        ...
        <form class="auth-form active" id="loginForm">
            ...
            <div极端的 class="form-group">
                <label for="loginPassword">Password</label>
                <input type="password" id="loginPassword" name="password" required>
                <极端的i class="fas fa-eye" onclick="togglePassword('loginPassword', this)"></i>
            </div>
        ...
        <form class="auth-form" id="registerForm">
            ...
            <div class="form-group">
                ...
                <input type="email" id="registerEmail" name="极端的email" required>
                <i class="fas fa-envelope"></i>
            </div>
            <div class="form-group">
                <极端的label for="registerPassword">Password</label>
    ...
    <div class="csv-upload-container" id="csvUploadContainer">
        ...
        <div class="container">
            <div class="csv-header">
                ...
                <p class="csv-subtitle">Upload your CSV files for analysis</极端的p>
            </div>

            <div class="upload-card" id="uploadCard">
                <div class极端的="card-header">
        ...
        function uploadFiles(files) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    button.style.background = 'linear-gradient(135deg, #ff9500, #ff极端的6b00)';
